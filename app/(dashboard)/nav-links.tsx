			...
			{links.map((link) => {
				...
				return (
					<Link
						...
						href={link.href}
						className={clsx(
							"flex h-[48px] grow items-center justify-center gap-2 rounded-md bg-snow-50 p-3 text-sm font-medium hover:bg-snow-100 hover:text-green-300 md:flex-none md:justify-start md:p-2 md:px-3",
							{
